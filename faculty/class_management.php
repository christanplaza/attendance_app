...
<head>
    ...
    <title>USLS HEU ATTENDANCE MONITORING APP | Faculty</title>
</head>
                ...
                <div class="col-8">
                    <div class="card shadow">
                        <div class="card-body">
                            ...
                            ?>
                            <div class="display-6">Your Classes</div>
                            <div class="row mt-4">
                                <div class="col-12">
                                        ...
                                        <tbody>
                                            <?php while ($row = $classes_result->fetch_assoc()) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= $rootURL; ?>/faculty/class_management/class.php?id=<?php echo $row['id']; ?>" class="btn btn-primary mx-2">View Details</a>
                                                        <!-- <a href="<?= $rootURL; ?>/faculty/class_management/edit_class.php?id=<?= $row['id']; ?>" class="btn btn-warning mx-2">Edit</a>
