...
$sql = "SELECT c.id, c.title, s.id AS schedule_id, s.day_of_week, s.time_start, s.time_end, c.absence_limit
        FROM classes c
...
if ($result) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $remainingAbsences = $class['absence_limit'] - $absentCount;
        ...
        $response = array(
            ...
            'absence_limit' => $class['absence_limit'],
